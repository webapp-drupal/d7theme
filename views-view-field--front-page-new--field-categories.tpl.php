...
foreach($terms as $term)
{
	...
	if(in_array(htmlentities($term->tid),$section_array))
	{
 	...
 	if($section_array[0] == 8268)
	{echo '<div class = "politics">'; //break;	
}
elseif($section_array[0] == 8277)
	{echo '<div class = "culture">'; //break;
	}	
elseif($section_array[0] == 8300)
	{echo '<div class = "scitech">'; //break;
	}	
elseif($section_array[0] = 8320)
	{echo '<div class = "world">'; 	//break;
