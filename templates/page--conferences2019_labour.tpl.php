...
<div id="container" class="conferences-theme">
  <?php if(arg(0) == 'conferences2018_labour'): ?>
  <div class="article-featured-image">
   <?php ?> <h1>Labour</h1>
    <div class="article-featured-image"><?php 
$imgpath = "https://www.newstatesman.com/sites/all/themes/creative-responsive-theme/images/conference_labour.jpg" ; 
$fimage = array(
  '#tag' => 'meta', 
  '#attributes' => array(
    'property' => 'og:image',
...
drupal_add_html_head($fimage, 'og_image'); 
  ...
  <?php ?> <img src="<?php print base_path() . drupal_get_path('theme', 'creative_responsive_theme') . '/images/conference_labour.jpg'; ?>" >
 ...
 <?php endif ?>
    ...
    <div class="large-12 columns">
      <div id="content" class="row">
       ...
       <?php if(arg(0) == 'conferences2019_labour'): ?>
                 <aside class="large-2 columns article-meta"> <br />
               <div id="container" class="event-theme">
               <?php print render($page['event_aside']); ?> 
                  ...
                  <ul class="share-buttons">
                                <li class='facebook-button st_facebook_hcount'><a target="_blank" href='https://www.facebook.com/sharer.php?u=<?php echo $base_url?>/conferences2017_labour &t=Conferences'  >
                                <span class="stButton">
                                ...
                                <li class='twitter-button st_twitter_hcount'><a target="_blank" href='https://twitter.com/share?url=<?php echo $base_url?>/conferences2017_labour' >
                                <span class="stButton">
                                ...
                                <li class='reddit-button st_reddit_hcount' ><a target="_blank" href='https://www.reddit.com/submit?url=<?php echo $base_url ?>/conferences2017_labour &title=Conferences'  >
                                <span class="stButton">
                         ...
                         <!--   <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php //echo $title; ?>" title="Email to a friend/colleague"> -->
                                     <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php echo $title; ?> &body=<?php echo $base_url.'/conferences2018_labour';?>&#32;&#32;" title="Email to a friend/colleague"> 
                                <span class="stButton" >
