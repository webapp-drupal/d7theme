...
<div id="container" class="conferences-theme">
  <?php if(arg(0) == 'conferences_liberal'): ?>
       ...
       <?php if(arg(0) == 'conferences_liberal'): ?>
               ...
               <?php print render($page['event_aside']) ?>    
                  ...
                  <ul class="share-buttons">
                                <li class='facebook-button st_facebook_hcount'><a target="_blank" href='https://www.facebook.com/sharer.php?u=<?php echo $base_url?>/conferences_liberal &t=Conferences'  >
                                <span class="stButton">
                                ...
                                <li class='twitter-button st_twitter_hcount'><a target="_blank" href='https://twitter.com/share?url=<?php echo $base_url?>/conferences_liberal' >
                                <span class="stButton">
                                ...
                                <li class='reddit-button st_reddit_hcount' ><a target="_blank" href='https://www.reddit.com/submit?url=<?php echo $base_url ?>/conferences_liberal &title=Conferences'  >
                                <span class="stButton">
                         ...
                         <!--   <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php //echo $title; ?>" title="Email to a friend/colleague"> -->
                                     <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php echo $title; ?> &body=<?php echo $base_url.'/conferences_liberal';?>&#32;&#32;" title="Email to a friend/colleague"> 
                                <span class="stButton" >
