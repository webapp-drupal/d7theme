<!-- Infinite Ad Serving on culturehome Section -->
...
alert('hello');
var something=<?php echo json_encode($section1); ?>;
alert(something);
alert(<?php echo json_encode($section); ?>);
alert('end');
  ...
  function moreContent1() {
   ...
   googletag.cmd.push(function() {
     var slot1 = googletag.defineSlot('/5269235/New_Statesman_2015_Dynamic_Bottom_Leaderboard', [728, 90], slotName1).
         setTargeting("Section", "culturehome").
