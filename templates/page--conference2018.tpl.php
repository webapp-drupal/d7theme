...
<li><a href="#" style="background-color: #000;color: #fff;">Conferences 2018</a></li>				 
...
<div class="large-12 columns conference-spacing" style="margin-top:100px;">
<!-- 
<div class="conferences-fringe-events"><a href="/sites/all/themes/creative-responsive-theme/images/Fringe_Events_Schedule.pdf" target="_blank">New Statesman Fringe Events Schedule</a></div> -->
...
<div class="large-6 columns conference-right"> <br />
                  ...
                  <ul class="share-buttons">
                                <li class='facebook-button st_facebook_hcount'><a target="_blank" href='https://www.facebook.com/sharer.php?u=<?php echo $base_url?>/conference2017 &t=Conferences'  >
                                <span class="stButton">
                                ...
                                <li class='twitter-button st_twitter_hcount'><a target="_blank" href='https://twitter.com/share?url=<?php echo $base_url?>/conference2017' >
                                <span class="stButton">
                                ...
                                <li class='reddit-button st_reddit_hcount' ><a target="_blank" href='https://www.reddit.com/submit?url=<?php echo $base_url ?>/conference2017 &title=Conferences'  >
                                <span class="stButton">
                         ...
                         <!--   <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php //echo $title; ?>" title="Email to a friend/colleague"> -->
                                     <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php echo $title; ?> &body=<?php echo $base_url.'/conference2017';?>&#32;&#32;" title="Email to a friend/colleague"> 
                                <span class="stButton" >
