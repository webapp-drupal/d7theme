...
<div id="container" class="conferences-theme">
  <?php if(arg(0) == 'conferences2018_conservative'): ?>
  <div class="article-featured-image">
   <?php ?> <h1>Conservatives</h1>
    <div class="article-featured-image"><?php 
$imgpath = "https://www.newstatesman.com/sites/all/themes/creative-responsive-theme/images/conference_conservative.jpg" ; 
$fimage = array(
  '#tag' => 'meta', 
  '#attributes' => array(
    'property' => 'og:image',
...
drupal_add_html_head($fimage, 'og_image'); 
	...
	<?php print render($page['conference2015_leadimage']) ?>
	<?php ?> <img src="<?php print base_path() . drupal_get_path('theme', 'creative_responsive_theme') . '/images/conference_conservative.jpg'; ?>" >
      ...
      <div id="content" class="row">
			...
			<div class="large-12 columns">
				<div class="conferences-landing-parties">
					...
					<ul>
					 <!--<li><a href="/conference2017/">Conferences 2017</a></li>--->
					 <li><a href="/conference2019/"  style="background-color: #000;color: #fff;">Conferences 2019</a></li>
					 <!-- <li><a href="/conferences2017_liberal/">Liberal Democrats</a></li>--->
					  <li><a href="/conferences2019_labour/">Labour</a></li>
					  <li><a href="/conferences2019_conservative/">Conservatives</a></li>
					 <!--  <li><a href="/conferences2017_scottish">SNP</a></li>-->
       ...
       <?php if(arg(0) == 'conferences2019_conservative'): ?>
               ...
               <?php print render($page['event_aside']) ?>    
                  ...
                  <ul class="share-buttons">
                                <li class='facebook-button st_facebook_hcount'><a target="_blank" href='https://www.facebook.com/sharer.php?u=<?php echo $base_url?>/conferences2017_conservative &t=Conferences'  >
                                <span class="stButton">
                                ...
                                <li class='twitter-button st_twitter_hcount'><a target="_blank" href='https://twitter.com/share?url=<?php echo $base_url?>/conferences2017_conservative' >
                                <span class="stButton">
                                ...
                                <li class='reddit-button st_reddit_hcount' ><a target="_blank" href='https://www.reddit.com/submit?url=<?php echo $base_url ?>/conferences2017_conservative &title=Conferences'  >
                                <span class="stButton">
                         ...
                         <!--   <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php //echo $title; ?>" title="Email to a friend/colleague"> -->
                                     <li class="email-button st_email_hcount"><a href="mailto:type email address here?subject=<?php echo $title; ?> &body=<?php echo $base_url.'/conferences2018_conservative';?>&#32;&#32;" title="Email to a friend/colleague"> 
                                <span class="stButton" >
