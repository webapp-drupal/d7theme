...
<?php else: ?>  
  ...
  <div class="student-cta">
    <p>If you are a student, trial us for £1 per week below, then, enjoy up to a FURTHER 25% off thereafter. Not a student?  <a href="/<?php echo variable_get('paywall_main_subscribe_page'); ?>">Click here</a></p>
  </div>
        ...
        <div class="subscription-option print-subscription">
          ...
          <div class="product-image">
            <img src="https://www.newstatesman.com/sites/default/files/styles/large/public/new-statesman-print-subscription_0.jpg" alt="New Statesman magazines">
		      ...
		      <div class="cta"><a href="/<?php echo variable_get('paywall_main_student_subscribe_page'); ?>?id=<?php echo variable_get('paywall_PM_student_print_id'); ?>&productName=<?php echo variable_get('paywall_PM_student_print_name'); ?>&productTitle=<?php echo urlencode('Student Print Only'); ?>">Subscribe now</a></div>
          <div class="offer">
        ...
        <div class="subscription-option print-digital-subscription best-value">
          ...
          <div class="app-images">
            ...
            <img src="https://www.newstatesman.com/sites/default/files/styles/large/public/google-play.png" alt="Google Play">
		      ...
		      <div class="cta"><a href="/<?php echo variable_get('paywall_main_student_subscribe_page'); ?>?id=<?php echo variable_get('paywall_PM_student_print_digital_id'); ?>&productName=<?php echo variable_get('paywall_PM_student_print_digital_name'); ?>&productTitle=<?php echo urlencode('Student Print and Digital'); ?>">Subscribe now</a></div>
          <div class="offer">
              <h3><small>Introductory offer</small>
              <span class="astrick">*</span>
        ...
        <div class="subscription-option digital-subscription">
          ...
          <div class="app-images">
            ...
            <img src="https://www.newstatesman.com/sites/default/files/styles/large/public/google-play.png" alt="Google Play">
		      ...
		      <div class="cta"><a href="/<?php echo variable_get('paywall_main_student_subscribe_page'); ?>?id=<?php echo variable_get('paywall_PM_student_digital_id'); ?>&productName=<?php echo variable_get('paywall_PM_student_digital_name'); ?>&productTitle=<?php echo urlencode('Student Digital Only'); ?>">Subscribe now</a></div>
