    ...
    <div class="row">
      <div class="large-4 columns">
        <div class="subscription-option print-subscription">
          ...
          <div class="cta"><a href="/subscribeCLF12?id=<?php echo variable_get('paywall_PM_adult_print_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>&payment-plans=PrintPlanCLF12">Subscribe now</a></div>

          <div class="offer">
              <h3><span class="astrick">*</span>12 issues for £12</h3>
              <div class="reduced-price">then £41 per quarter thereafter</div>
      ...
      <!--<div class="cta"><a href="/ev-subscribe?id=5a817e8d25c61214ae248c12&productName=Print&Digital">Subscribe now</a></div>-->
        <div class="cta"><a href="/subscribeCLF12?id=<?php echo variable_get('paywall_PM_adult_print_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_digital_name') ?>&productTitle=<?php echo urlencode('Digital and Print'); ?>&payment-plans=PrintandDigital_CLF_oneyear_UK_131">Subscribe now</a></div>
          <div class="offer">
              <h3><span class="astrick">*</span>1 year for £131</h3>
      ...
      <div class="large-4 columns">
        <div class="subscription-option digital-subscription">
          ...
          <!-- .app-images -->
          <div class="cta"><a href="/subscribeCLF12?id=<?php echo variable_get('paywall_PM_adult_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_digital_name') ?>&productTitle=<?php echo urlencode('Digital Only'); ?>&payment-plans=Digital_CLF_oneyear_120">Subscribe now</a></div>
          <div class="offer">
              <h3><span class="astrick">*</span>1 year for £120</h3>
