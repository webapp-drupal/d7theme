  ...
  <div class="step-1-2">
    <p>
      ...
      <ev-product-selection id="<?php echo $sanitized_product_id; ?>" 
                           ...
                           show-header="false"
                           <?php if($sanitized_product_name != 'election2019_digital' ) echo 'show-delivery-country="true" default-country="United Kingdom"'; ?>
						   show-hidden="true">
...
<?php else: ?>
  ...
  <header class="subscription-header">
    <h1>Who will be in power after 12 December?</h1>
    <p>Get the best political analysis, expert opinion and great journalism in the run-up to the election. </br>Try the  <span style="font-weight: bold;font-style: italic;">New Statesman</span> for just £1 per week!</p>
    <p></p>
  </header>
    ...
    <div class="row">
      <div class="large-4 columns">
        <div class="subscription-option print-subscription">
          ...
          <div class="product-image">
		    ...
		    <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_election_print_id') ?>&productName=<?php echo variable_get('paywall_PM_election_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>"><strong>12 weeks for just &#163;12</strong></a></div>
		      <!--<div class="cta"><a href="?id=5dc943f925c6120404a21c5c&productName=election2019_print&productTitle=<?php echo urlencode('Print Only'); ?>">12 weeks for just &#163;12</a></div>-->

          
         <ev-product-selection id="5dcc0a10086fa55a8026dff2" 
      ...
      <div class="large-4 columns">
        <div class="subscription-option print-digital-subscription best-value">
		  ...
		  <!--<div class="cta"><a href="/ev-subscribe?id=5a817e8d25c61214ae248c12&productName=Print&Digital">Subscribe now</a></div>-->
		    <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_election_print_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_election_print_digital_name') ?>&productTitle=<?php echo urlencode('Digital and Print'); ?>"><strong>12 weeks for just &#163;12</strong></a></div>
         
          <ev-product-selection id="<?php echo variable_get('paywall_PM_election_print_digital_id'); ?>" 
                    product-name="<?php echo variable_get('paywall_PM_election_print_digital_name'); ?>"
      ...
      <div class="large-4 columns">
        <div class="subscription-option digital-subscription">
          ...
          <!-- .app-images -->
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_election_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_election_digital_name') ?>&productTitle=<?php echo urlencode('Digital_Only'); ?>"><strong>12 weeks for just &#163;12</strong></a></div>
          
          <ev-product-selection id="5dcc0bc4673ce07e4136697f" 
                           product-name="election2019_digital"
                           title="Digital Only"
                           show-header="false">
          </ev-product-selection>
