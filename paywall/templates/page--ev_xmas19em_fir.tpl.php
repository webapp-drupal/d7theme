...
<?php else: ?>
  ...
  <style>
        #container-christmas:before {
          ...
          right: 0;
          height: 1120px;
          background-image: url(https://www.newstatesman.com/sites/default/files/fir.png);
          background-size: 100%;
  ...
  ?>
	  <header class="subscription-header">
		...
		<p>Please note that all subscriptions will start after 25th December 2019. If you would like your subscription to start earlier, please contact us on +44 20 7030 4927  or email us on <a href="mailto:subs@newstatesman.co.uk">subs@newstatesman.co.uk</a>.</p>
	  </header>
  <?php }else{ ?>
	  <header class="subscription-header">
		<h1>Merry Christmas from the <span style="font-style: italic;">New Statesman</span>!</h1>
      ...
      <div class="large-4 columns">
        <div class="subscription-option print-subscription">
          <h2>Print</h2>
           <div class="product-image mb-3">
			  ...
			  <div class="cta"><a href="?id=5db96449673ce07e41166d9c&productName=xmas_2019_print_icard&productTitle=<?php echo urlencode('Xmas 2019 Print ICard'); ?>&startDate=25122019">From &#163;49.99</a></div>


          <ev-product-selection id="5db96449673ce07e41166d9c"
                    product-name="xmas_2019_print_icard"
                    title="Print Only"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
        ...
        <div class="large-4 columns">
			<div class="subscription-option print-digital-subscription best-value">
			  ...
			  <div class="cta"><a href="?id=5db963e4086fa55a8008f685&productName=xmas_2019_print_digital_icard&productTitle=xmas_2019_print_digital_icard&startDate=25122019">From &#163;77</a></div>


          <ev-product-selection id="5db963e4086fa55a8008f685"
                    product-name="xmas_2019_print_digital_icard"
        ...
        <div class="large-4 columns">
			<div class="subscription-option digital-subscription">
			  ...
			  <div class="cta"><a href="?id=5db96351673ce07e4115deb4&productName=xmas_2019_digital_icard&productTitle=xmas_2019_digital_icard&startDate=25122019">From &#163;49.99</a></div>


          <ev-product-selection id="5db96351673ce07e4115deb4"
                    product-name="xmas_2019_digital_icard"
      ...
      <div class="large-5 columns" style="margin-left: 8%; padding-right: 2%; padding-left: 3%;">
        <div class="subscription-option print-subscription">
          <h2>Print</h2>
           <div class="product-image mb-3">
			  ...
			  <div class="cta"><a href="?id=5db96212086fa55a8007d905&productName=xmas_2019_print_sm&productTitle=<?php echo urlencode('Xmas 2019 Print Social Media'); ?>&startDate=25122019"><strong>From &#163;49.99</strong></a></div>


          <ev-product-selection id="5db96212086fa55a8007d905"
                    product-name="xmas_2019_print_sm"
                    title="Digital Only"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
        ...
        <div class="large-5 columns" style="margin-right: 8%; padding-right: 3%; padding-left: 2%;">
			<div class="subscription-option print-digital-subscription">
			  ...
			  <div class="cta"><a href="?id=5db962a4086fa55a80082055&productName=xmas_2019_digital_sm&productTitle=<?php echo urlencode('Xmas 2019  Digital SM'); ?>&startDate=25122019"><strong>From &#163;49.99</strong></a></div>


          <ev-product-selection id="5db962a4086fa55a80082055"
                    product-name="xmas_2019_digital_sm"
                    title="Digital"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
