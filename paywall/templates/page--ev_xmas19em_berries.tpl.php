  ...
  <div class="step-1-2">
	...
	<!--<ev-product-selection id="5DAD8A4D25C612698782B328"
	  ...
	  <ev-product-selection id="<?php echo $sanitized_product_id; ?>"
                           ...
                           show-header="false"
						   <?php if($sanitized_product_name != 'xmas_2019_digital_email' ) echo 'show-delivery-country="true" default-country="United Kingdom"'; ?>
						   show-hidden="true">
      </ev-product-selection>
      ...
      <div class="large-4 columns">
        <div class="subscription-option print-subscription">
		  ...
		  <!-- EVolok Production product id --->
			<div class="cta"><a href="?id=5db27e08673ce02b49b8bd17&productName=xmas_2019_print_email&productTitle=<?php echo urlencode('Xmas 2019 Print Email'); ?>&startDate=25122019">From &#163;49.99</a></div>


          <ev-product-selection id="5db27e08673ce02b49b8bd17"
                    product-name="xmas_2019_print_email"
                    title="Print Only"
                    show-header="false"
					show-hidden="true">
			...
			<!-- Evlok UAT Product id---->
			  <!--<div class="cta"><a href="?id=5daeadda25c6126987a9f8a3&productName=xmas_2019_print_digital_email&productTitle=<?php //echo urlencode('Xmas 2019 Print and Digital Email'); ?>">From &#163;77</a></div>
				...
				<!-- Evolok Production Product id --->
				 ...
				 <div class="cta"><a href="?id=5db27f70086fa50c678d46bc&productName=xmas_2019_print_digital_email&productTitle=<?php echo urlencode('Xmas 2019 Print and Digital Email'); ?>&startDate=25122019">From &#163;77</a></div>


				<ev-product-selection id="5db27f70086fa50c678d46bc"
						product-name="xmas_2019_print_digital_email"
						title="Print and Digital"
						show-header="false"
						show-hidden="true">
        ...
        <div class="large-4 columns">
			<div class="subscription-option digital-subscription">
			  ...
			  <div class="cta"><a href="?id=5db28346673ce02b49b9d5d2&productName=xmas_2019_digital_email&productTitle=<?php echo urlencode('Xmas 2019 Print Email'); ?>&startDate=25122019">From &#163;49.99</a></div>


				<ev-product-selection id="5db28346673ce02b49b9d5d2"
						product-name="xmas_2019_digital_email"
						title="XMAS 2019 Digital "
						show-header="false"
						show-hidden="true">
