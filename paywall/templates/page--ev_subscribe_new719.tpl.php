    ...
    <div class="row">
      <div class="large-4 columns">
        <div class="subscription-option print-subscription">
          ...
          <div class="product-image">
		      ...
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_print_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>&payment-plans=print_12for12_quarterly_new"><strong>12 weeks for £12</strong></a></div>
      ...
      <div class="large-4 columns">
        <div class="subscription-option print-digital-subscription best-value">
          ...
          <!-- .app-images -->
		    <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_print_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_digital_name') ?>&productTitle=<?php echo urlencode('Digital and Print'); ?>&payment-plans=Bound_insert12412_1499"><strong>12 weeks for £12</strong></a></div>
      ...
      <div class="large-4 columns">
        <div class="subscription-option digital-subscription">
          ...
          <!-- .app-images -->
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_digital_name') ?>&productTitle=<?php echo urlencode('Digital Only'); ?>&payment-plans=12for12_digital_new"><strong>12 weeks for £12</strong></a></div>
