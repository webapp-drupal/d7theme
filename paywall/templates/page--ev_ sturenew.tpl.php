...
<?php else: ?>
  ...
  <section class="subscription-options" id="start">
    <div class="student-cta">
      <p>Not a student?  <a href="/<?php echo variable_get('paywall_main_subscribe_page'); ?>">Click here</a></p>
    ...
    <div class="row">
      <div class="large-6 columns">
        <div class="subscription-option print-subscription">
          ...
          <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_student_print_id') ?>&productName=<?php echo variable_get('paywall_PM_student_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>&payment-plans=student_print_one_year_ONEOFF_90,student_print_two_year_ONEOFF_15750">Subscribe now</a></div>

          <div class="offer">
              <h3><span class="astrick">*</span>1 year for £90</h3>
              <div class="reduced-price"><span class="old-price">£4.50</span> £1.73 per week</div>
      ...
      <!--<div class="cta"><a href="/ev-subscribe?id=5a817e8d25c61214ae248c12&productName=Print&Digital">Subscribe now</a></div>-->
        <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_student_print_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_student_print_digital_name') ?>&productTitle=<?php echo urlencode('Student Print and Digital'); ?>&payment-plans=student_print_digital_one_year_ONEOFF_115">Subscribe now</a></div>
          <div class="offer">
              <h3><span class="astrick">*</span>1 year for £115</h3>
              <div class="reduced-price"><span class="old-price">£4.50</span> £2.21 per week</div>
              <span>Orders will start with the next available issue</span> 
          </div>
          <ev-product-selection id="<?php echo variable_get('paywall_PM_student_print_digital_id') ?>" 
                    product-name="<?php echo variable_get('paywall_PM_student_print_digital_name') ?>"
                     title="Student Print and Digital"
                    show-header="false">
          </ev-product-selection>
        </div>
        <!-- .subscription-option -->
