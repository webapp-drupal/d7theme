  ...
  <div class="step-1-2">
    <p>
      ...
      <ev-product-selection id="<?php echo $sanitized_product_id; ?>" 
                           ...
                           show-header="false"
                           <?php if($sanitized_product_name != 'BRITELECT_digital' ) echo 'show-delivery-country="true" default-country="United Kingdom"'; ?>
						   show-hidden="true">
...
<?php else: ?>
  ...
  <header class="subscription-header">
    ...
    <p>Get the best political analysis, expert opinion and great journalism in the run-up to the election. </br>Try the  <span style="font-weight: bold;font-style: italic;">New Statesman</span> from just £49.99!</p>
    <p></p>
  </header>
    ...
    <div class="row">
      <div class="large-6 columns">
        <div class="subscription-option print-subscription">
          ...
          <div class="product-image">
		    ...
		    <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_election_elects_print_id') ?>&productName=<?php echo variable_get('paywall_PM_election_elects_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>"><strong>From £49.99</strong></a></div>
         ...
         <ev-product-selection id="<?php echo variable_get('paywall_PM_election_elects_print_id') ?>" 
                    product-name="<?php echo variable_get('paywall_PM_election_elects_print_name') ?>"
                    title="Print Only"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
      ...
      <div class="large-6 columns">
        <div class="subscription-option digital-subscription">
          ...
          <!-- .app-images -->
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_election_elects_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_election_elects_digital_name') ?>&productTitle=<?php echo urlencode('Digital_Only'); ?>"><strong>From £49.99</strong></a></div>
          
          <ev-product-selection id="<?php echo variable_get('paywall_PM_election_elects_digital_id') ?>" 
                           product-name="<?php echo variable_get('paywall_PM_election_elects_digital_name') ?>"
                           title="Digital Only"
                           show-header="false"
						   show-hidden="true">
          </ev-product-selection>
