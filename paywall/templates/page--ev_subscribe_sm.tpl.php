...
<?php else: ?>
  ...
  <header class="subscription-header">
    ...
    <p><strong>Try the New Statesman now for just £12 for 12 weeks!</strong> Enlightened thinking in dark times</p>
    <p></p>
  </header>
    ...
    <div class="row">
        ...
        <div class="subscription-option print-subscription">
          ...
          <div class="product-image">
            <!--<img src="https://www.newstatesman.com/sites/default/files/styles/large/public/new-statesman-print-subscription_0.jpg" alt="New Statesman magazines">-->
		      ...
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_print_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_name') ?>&productTitle=<?php echo urlencode('Print Only'); ?>&payment-plans=print_12for12_Facebook"><strong>12 weeks for £12</strong></a></div>
      ...
      <div class="large-4 columns">
        <div class="subscription-option print-digital-subscription best-value">
          ...
          <!-- .app-images -->
		    <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_print_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_print_digital_name') ?>&productTitle=<?php echo urlencode('Digital and Pring'); ?>&payment-plans=Print_digital_12for12_Facebook"><strong>12 weeks for £12</strong></a></div>
      ...
      <div class="large-4 columns">
        <div class="subscription-option digital-subscription">
          ...
          <!-- .app-images -->
		      <div class="cta"><a href="?id=<?php echo variable_get('paywall_PM_adult_digital_id') ?>&productName=<?php echo variable_get('paywall_PM_adult_digital_name') ?>&productTitle=<?php echo urlencode('Digital Only'); ?>&payment-plans=digital_12for12_Facebook"><strong>12 weeks for £12</strong></a></div>
