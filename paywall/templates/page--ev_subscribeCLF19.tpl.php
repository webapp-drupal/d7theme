...
<?php else: ?>
  ...
  <!-- <img src="<?php //echo 'https://'.$_SERVER['HTTP_HOST'].'/sites/default/files/clflogo_0.png'; ?>"  class="img-responsive center-block"/> -->
    ...
    <div class="row">
        ...
        <div class="subscription-option print-subscription">
          <h2>Print</h2>
           <div class="product-image mb-3">
			  ...
			  <div class="cta"><a href="?id=5dcd2b8c673ce07e414f23ed&productName=subscribeCLF19_print_only&productTitle=<?php echo urlencode('Print'); ?>">FROM &#163;49.99</a></div>


          <ev-product-selection id="5dcd2b8c673ce07e414f23ed"
                    product-name="subscribeCLF19_print_only"
                    title="Print Only"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
	  ...
	  <div class="large-5 columns" style="margin-right: 8%; padding-right: 3%; padding-left: 2%;">
			<div class="subscription-option print-digital-subscription">
			  ...
			  <div class="cta"><a href="?id=5dca3ec525c6120404ad4915&productName=subscribeCLF19_print_digital&productTitle=<?php echo urlencode('Print & Digital'); ?>">FROM &#163;77</a></div>


          <ev-product-selection id="5dcd2aa8086fa55a803fbc79"
                    product-name="subscribeCLF19_print_digital"
                    title="Print & Digital"
                    show-header="false"
					show-hidden="true">
          </ev-product-selection>
       ...
       <!-- <div class="large-5 columns" style="margin-right: 8%; padding-right: 3%; padding-left: 2%;">
			<div class="subscription-option print-digital-subscription">
			 ...
			 <!-- <div class="cta"><a href="?id=5db962a4086fa55a80082055&productName=xmas_2019_digital_sm&productTitle=<?php //echo urlencode('Xmas 2019  Digital SM'); ?>&startDate=25122019">From &#163;99</a></div>
