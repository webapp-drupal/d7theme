...
if (is_array($section_array)) {
	$section_array = array_map('trim', $section_array);
        ...
        }elseif(in_array('LIVING HEALTH', $section_array)) {
			$cat = l('Living health','taxonomy/term/8373');		    
        }
    }
...
//if(is_array($row->field_field_guest_author) && array_key_exists(0, $row->field_field_guest_author))
